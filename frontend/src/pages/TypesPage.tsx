...
const TypesPage = () => {
    ...
    const handleDeleteConfirm = async () => {
        if (selectedType) {
            try {
                await axios.delete(`http://localhost:8080/api/recipe-type/${selectedType.id}`);
    ...
    const handleEditClick = (type) => {
        // Переход на сторінку редагування типу
    ...
    return (
        <>
            ...
            <div className="mx-[15vw]">
                <h1 className="text-relative-h3 my-[7vh] font-kharkiv font-bold mb-4">Типи рецептів</h1>
                ...
                {isModalOpen && (
                    <div className="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            <p className="mb-4">
                                Ви впевнені, що хочете видалити тип "{selectedType.type_name}"? Усі рецепти цього типу також будуть видалені.
                            </p>
