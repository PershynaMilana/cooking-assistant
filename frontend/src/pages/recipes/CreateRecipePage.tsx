        ...
        <div>
            ...
            <div className="mx-[15vw]">
                ...
                <form className="space-y-4">
                    ...
                    <div>
                        <label
                            htmlFor="create-recipe-description"
                            className="block text-sm font-medium text-gray-700"
                        >
                            Description
                        </label>
                    ...
                    <div>
                        <label
                            htmlFor="create-recipe-cooking-time"
                            className="block text-sm font-medium text-gray-700"
                        >
                            Cooking Time (hh:mm)
                        </label>
                        <input
                            id="create-recipe-cooking-time"
                            type="text"
                    ...
                    <div>
                        <label
                            htmlFor="create-recipe-servings"
                            className="block text-sm font-medium text-gray-700"
                        >
                            Servings (for which container is the recipe
                            calculated):
                        </label>
                        <input
